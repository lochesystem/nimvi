#!/usr/bin/env python3
"""Render the complete Soruli laboratory evolution sequence as a GIF."""
...
OUT = ROOT / "docs/assets/nimvi-soruli-evolution.gif"
SIZE = (800, 600)
CELL = (313, 250)
INK = "#17142b"
...
def main() -> None:
    old_sheet = ROOT / "public/sprites/nimvi-soruli.png"
    new_sheet = ROOT / "public/sprites/nimvi-soruli-stage2.png"
