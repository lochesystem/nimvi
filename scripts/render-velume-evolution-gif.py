#!/usr/bin/env python3
"""Render the complete Velume laboratory evolution sequence as a GIF."""
...
OUT = ROOT / "docs/assets/nimvi-velume-evolution.gif"
SIZE = (800, 600)
CELL = (313, 250)
INK = "#17142b"
...
def main() -> None:
    old_sheet = ROOT / "public/sprites/nimvi-velume.png"
    new_sheet = ROOT / "public/sprites/nimvi-velume-stage2.png"
